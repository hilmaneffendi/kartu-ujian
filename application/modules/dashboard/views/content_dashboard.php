					...
					<td class="col-md-3">
						...
						<div class="media-left">
							<h5 class="text-semibold no-margin">
								<?php 
									echo $this->db->query('SELECT * FROM `t_mahasiswa`')->num_rows();
								 ?>	
								<small class="display-block no-margin">Data Mahasiswa</small>
							</h5>
						</div>
					</td>
					<td class="col-md-3">
						<div class="media-left media-middle">
							<a href="#" class="btn border-indigo-400 text-indigo-400 btn-flat btn-rounded btn-xs btn-icon"><i class="icon-credit-card"></i></a>
						</div>
						<div class="media-left">
							<h5 class="text-semibold no-margin">
								<?php 
									echo $this->db->query('SELECT * FROM `t_kartu`')->num_rows();
								 ?>	
								 <small class="display-block no-margin">Data Kartu</small>
							</h5>
						</div>
					</td>
					<td class="col-md-3">
